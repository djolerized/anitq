...
?>
    <div class="comments">
        <h2 class="postheader nocomments"><?php _e('This post is password protected. Enter the password to view any comments.', THEME_NS) ?></h2>
    </div>
<?php
	return;
}
...
?>
    <div class="comments">
        <h2 class="postheader comments"><?php printf(
...
echo str_replace(
    ...
    array('id="respond" class="commentsform"', '<h2', 'id="reply-title" class="postheader"', '</h2>', 'postcontent logged-in-as', 'class="button" type="submit"'), 
    theme_ob_get_clean());